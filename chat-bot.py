...
#        
## doin a first cleaning of the texts
#        
#def clean_text(text):
#    text = text.lower()
...
#    clean_answers[i] += '<EOS>'
#
##teanslating all the questions and the answers into the integers
...
#
##sorting questions answers by the length of questions 
...
#sequence_length = tf.placeholder_with_default(25, None, name='sequence_legth')
#
#input_shape = tf.shape(inputs)
#
##getting the training and tst predictions
...
#                                                       num_layers,
#                                                       questionswords2int)
##setting up the loss error , optimizer and gradient clippig
        ...
        if batch_index % batch_index_check_validation_loss == 0 and batch_index > 0:
            ...
            if average_validation_loss_error <= min (list_validation_loss_error):
                ...
                if early_stopping_check == early_stopping_stop:
                    break
    if early_stopping_check == early_stopping_stop:
        print("my apologies, icannot speak better anymore. this is the best i can do")
        break
print('game over')
